...
public class UsersController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        registrarUsuarioss.setOnMouseClicked(event ->{
            btnDepas.fire();
        });
        registrarDepartamento.setOnMouseClicked(event ->{
            btnDepas.fire();
        });
    ...
    @FXML
    public void btnDepartamentos(ActionEvent actionEvent){
        removerElementos();
        ...
        hb.setOnMouseClicked((actionEvents) ->{
            ...
            try {
                ...
                * btnVolver.setOnAction((e) ->{
                ...
                VBox actual = (VBox) vn1.lookup("VBox");
                ...
                btnBuscar.setOnAction(action ->{
                    ...
                    try {
                        ...
                        stage.setScene(scene);
                        stage.showAndWait();
                        VBox contenedor = (VBox) actual.lookup("#tablaEmpleados");
                        actual.getChildren().remove(contenedor);
                        actual.getChildren().add(tabla.mostrarTabla());
                    } catch (IOException e) {
                        throw new RuntimeException(e);
                    }
                });
    ...
    @FXML
    public void btnRegistrarUsuarios(ActionEvent event){
        //btnPacientes.fire();
    }
    @FXML
    public void btnRegistrarDepartamento(ActionEvent actionEvent){
        //btnDepartamentos(actionEvent);
    }
    @FXML
